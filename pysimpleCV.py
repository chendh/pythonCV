...
def make_window(theme=None):
    def name(name):
        ...
        return sg.Text(name + ' ' + '•' * dots, size=(NAME_SIZE, 1), justification='r', pad=(0, 0), font='Consolas 14')
    ...
    layout_l = [
        ...
        [name('Combo'),
         sg.Combo(sg.theme_list(), default_value=sg.theme(), s=(15, 22), enable_events=True, k='-COMBO-')],
    ...
    layout = [[sg.MenubarCustom([['File', ['Exit']], ['Edit', ['Edit Me', ]]], p=0)],
              [sg.T('PySimpleGUI Elements - Use Combo to Change Themes', font='Consolas 18', justification='c',
                    expand_x=True)],
